...
$categoria = obtenerClientesCategoriasConId($_GET["id"])["datos"];
?>
<!DOCTYPE html>
<html lang="es">
                ...
                <div class="card-body">
                  <form role="form">
                    ...
                    <div class="text-center">
                      <button type="button" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" onclick="clientesCat.modificar()">Modificar</button>
                    </div>
                  </form>
                </div>
              </div>
