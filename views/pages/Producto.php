...
$productos = obtenerProductos()["datos"];
?>
<!DOCTYPE html>
<html lang="es">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                ...
                <button type="button" class="btn bg-gradient-success btn-outline-success btn-sm mb-0" onclick="window.location.href='ProductoForm.php'">Crear</button>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Precio Dia</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?=$producto["productos_id"]?></p>
                      </td>
                      <td>
                        <p class="text-xs text-secondary mb-0"><?=$producto["SKU"]?></p>
                      </td>
                      <td>
                        <p class="text-xs text-secondary mb-0"><?=substr($producto["descripcion"],0,30)?></p>
                      </td>
                      <td>
                        <p class="text-xs text-secondary mb-0"><?="Q.".$producto["precio_dia"]?></p>
                      </td>
                      ...
                      <td class="align-middle">
                        <a href="<?=$dirViews?>/pages/ProductoMod.php?id=<?=$producto["productos_id"]?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Editar
                        </a>
                        <a href="javascript:productos.eliminar(<?=$producto["productos_id"]?>);" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Eliminar
                        </a>
                      </td>
                    </tr>
