            ...
            <div class="col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto">
              <div class="card card-plain">
                <div class="card-header">
                  <h4 class="font-weight-bolder">Crear Productos</h4>
                  <p class="mb-0">Ingrese la informacion para crear la producto.</p>
                </div>
                <div class="card-body">
                  <form role="form">
                    ...
                    <div class="form-check form-switch ps-0">
                      <input class="form-check-input ms-auto" type="checkbox" id="es_servicio">
                    ...
                    <div class="input-group input-group-outline mb-3">
                      ...
                      <input type="number" class="form-control" id="precio_hora">
                    </div>
                    <div class="input-group input-group-outline mb-3">
                      <label class="form-label">Precio Dia</label>
                      <input type="number" class="form-control" id="precio_dia">
                    </div>
                    <div class="form-check form-switch ps-0">
                    ...
                    <div class="form-check form-switch ps-0">
                      <input class="form-check-input ms-auto" type="checkbox" id="es_combo">
                    ...
                    <div class="text-center">
                      <button type="button" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" onclick="productos.crear()">Crear</button>
                    </div>
                  </form>
                </div>
              </div>
