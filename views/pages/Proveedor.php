...
$proveedores = obtenerProveedores()["datos"];
?>
<!DOCTYPE html>
<html lang="es">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                ...
                <button type="button" class="btn bg-gradient-success btn-outline-success btn-sm mb-0" onclick="window.location.href='ProveedorForm.php'">Crear</button>
              </div>
            </div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?=$proveedor["proveedores_id"]?></p>
                      </td>
                      <td>
                        <p class="text-xs text-secondary mb-0"><?=$proveedor["nit"]?></p>
                      </td>
                      <td>
                        <p class="text-xs text-secondary mb-0"><?=$proveedor["nombre"]?></p>
                      </td>
                      <td>
                      ...
                      <td class="align-middle">
                        <a href="<?=$dirViews?>/pages/ProveedorMod.php?id=<?=$proveedor["proveedores_id"]?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Editar
                        </a>
                        <a href="javascript:proveedores.eliminar(<?=$proveedor["proveedores_id"]?>);" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Eliminar
                        </a>
                      </td>
                    </tr>
