...
$cliente = obtenerClientesConId($_GET["id"])["datos"];
            ...
            <div class="col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto">
              <div class="card card-plain">
                <div class="card-header">
                  <h4 class="font-weight-bolder">Modificar Clientes</h4>
                  <p class="mb-0">Ingrese la informacion para modificar la cliente.</p>
                </div>
                <div class="card-body">
                  <form role="form">
                    <div class="input-group input-group-outline mb-3">
                      <label class="form-label">ID</label>
                      <input type="text" class="form-control" id="id" value="<?=$cliente["clientes_id"]?>">
                    </div>
                    <div class="input-group input-group-outline mb-3">
                      <label class="form-label">NIT</label>
                      <input type="text" class="form-control" id="nit" value="<?=$cliente["nit"]?>">
                    </div>
                    <div class="input-group input-group-outline mb-3">
                    ...
                    <div class="form-check form-switch ps-0">
                      <input class="form-check-input ms-auto" type="checkbox" id="estado" <?=($cliente["estado"] == 1?"checked":"")?>>
                    ...
                    <div class="input-group input-group-outline mb-3">
                      ...
                      <select class="form-select" aria-label="Default select example" id="categorias_id">
                        ...
                        <option 
                          ...
                          <?=($cliente["categorias_id"] == $categoria["categorias_id"]?"selected":"")?>>
                          <?=$categoria["nombre"]?>
                        </option>
                        <?php } ?>
                      </select>
                    ...
                    <div class="text-center">
                      <button type="button" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" onclick="clientes.modificar()">Modificar</button>
                    </div>
                  </form>
                </div>
              </div>
