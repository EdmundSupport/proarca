...
require_once("$dirModels/Clientes.php");
require_once("$dirModels/Personas.php");
$clientes = obtenerClientes()["datos"];
?>
<!DOCTYPE html>
<html lang="es">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                ...
                <button type="button" class="btn bg-gradient-success btn-outline-success btn-sm mb-0" onclick="window.location.href='ClienteForm.php'">Crear</button>
              </div>
            </div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    $persona = obtenerConId($cliente["personas_id"])["datos"]; 
                    ?> 
                    <tr>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?=$cliente["clientes_id"]?></p>
                      </td>
                      <td>
                        <p class="text-xs text-secondary mb-0"><?=$cliente["nit"]?></p>
                      </td>
                      <td>
                        <p class="text-xs text-secondary mb-0"><?=$cliente["nombre"]?></p>
                      </td>
                      <td>
                        <p class="text-xs text-secondary mb-0"><?=$persona["nombres"]." ".$persona["apellidos"]?></p>
                      </td>
                      ...
                      <td class="align-middle">
                        <a href="<?=$dirViews?>/pages/ClienteMod.php?id=<?=$cliente["clientes_id"]?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Editar
                        </a>
                        <a href="javascript:clientes.eliminar(<?=$cliente["clientes_id"]?>);" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Eliminar
                        </a>
                      </td>
                    </tr>
