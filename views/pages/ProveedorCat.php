          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Categoria Proveedores</h6>
                <button type="button" class="btn bg-gradient-success btn-outline-success btn-sm mb-0" onclick="window.location.href='ProveedorCatForm.php'">Crear</button>
              </div>
            </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="<?=$dirViews?>/pages/ProveedorCatMod.php?id=<?=$categoria["categorias_id"]?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Editar
                        </a>
                        <a href="javascript:proveedoresCat.eliminar(<?=$categoria["categorias_id"]?>);" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Eliminar
                        </a>
                        </td>
                    </tr>
